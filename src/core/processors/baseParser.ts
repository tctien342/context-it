import type { FunctionSignature, LanguageProcessor, Param } from '../../types/types';
...
export abstract class BaseParser implements LanguageProcessor {
   ...
   * Override this method in language-specific parsers
   */
  protected abstract parseFunctionSignature(fnDeclaration: string): FunctionSignature | null;
   ...
   * Override this method in language-specific parsers
   */
  protected abstract extractReturnType(fnDeclaration: string): string | undefined;
}